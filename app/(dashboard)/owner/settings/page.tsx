...
import { Loader2, Upload, X, CheckCircle2, AlertCircle, Crown } from "lucide-react";
                            ...
                            <form onSubmit={handleProfileSubmit} className="space-y-6">
                                ...
                                <div className="bg-purple-50 border-purple-200 p-4 rounded-md">
                                    <div className="flex">
                                        ...
                                        <div className="ml-3">
                                            <h3 className="text-sm font-medium text-purple-800">Owner Information</h3>
                                            <div className="mt-2 text-sm text-purple-700">
                                                <p>As the owner, you have full access to all system features and settings.</p>
