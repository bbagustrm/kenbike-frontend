                            ...
                            >
                                <div>
                                    <h2 className="text-xl md:text-2xl lg:text-3xl font-bold mb-1 text-foreground">
                                        {t.about?.shopByCategory || t.home?.shopByCategory || (locale === "id" ? "Belanja Berdasarkan Kategori" : "Shop by Category")}
                                    </h2>
                                    <p className="text-xs md:text-sm text-muted-foreground">
                                        {t.about?.shopByCategoryDescription || t.home?.shopByCategoryDescription || (locale === "id" ? "Jelajahi berbagai komponen sepeda kami" : "Explore our wide range of bike components")}
                                    </p>
                                </div>
                            </motion.div>
                        </ScrollReveal>
