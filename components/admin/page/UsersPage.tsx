// File: components/users/UsersPage.tsx
"use client";
...
export default function UsersPage({
    ...
    customDescription = "Manage users, roles, and permissions"
}: UsersPageProps) {
    ...
    // Helper function to check if the current user can perform an action on a target user
    const canPerformAction = (targetUser: User, action: string) => {
        ...
        // An admin cannot modify themselves
    ...
    const fetchUsers = useCallback(async () => {
        ...
        try {
            ...
            //   : await UserService.getOwnerUsers(params);
    ...
    }, [page, roleFilter, search, limit, activeTab, userRole]); // Tambahkan userRole ke dependency
                                                    ...
                                                    <div className="flex justify-end gap-2">
                                                        {activeTab === "active" ? (
                                                            <>
                                                                ...
                                                                {canPerformAction(user, "changeStatus") && (
                                                                    <Tooltip>
                                                                        <TooltipTrigger asChild>
                                                                            <Button
                                                                                variant="ghost"
                                                                ...
                                                                {canPerformAction(user, "forceLogout") && (
                                                                    <Tooltip>
                                                                        <TooltipTrigger asChild>
                                                                            <Button
                                                                                variant="ghost"
                                                            ...
                                                            <DropdownMenu>
                                                                ...
                                                                <DropdownMenuContent align="end">
                                                                    ...
                                                                    {canPerformAction(user, "restore") && (
                                                                        <DropdownMenuItem onClick={() => handleRestoreUser(user)}>
                                                                            <RotateCcw className="h-4 w-4 mr-2" />
                                                                            Restore
                                                                        </DropdownMenuItem>
                                                                    )}
                                                                    {canPerformAction(user, "hardDelete") && (
                                                                        <DropdownMenuItem
            ...
            <Dialog open={showUserDetailDialog} onOpenChange={setShowUserDetailDialog}>
                <DialogContent className="max-w-2xl">
                    <DialogHeader>
                        ...
                        <DialogDescription>Complete information about user</DialogDescription>
                    </DialogHeader>
                    {selectedUser && (
