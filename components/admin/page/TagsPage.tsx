// File: components/tags/TagsPage.tsx
"use client";
    ...
    return (
        <div className="container mx-auto py-8 px-4">
                                                    ...
                                                    <DropdownMenuContent align="end">
                                                        {activeTab === "active" ? (
                                                            ...
                                                            <>
                                                                ...
                                                                <DropdownMenuItem
                                                                    className="text-destructive"
                                                                    onClick={() => setHardDeleteDialog({ open: true, id: tag.id })}
                                                                >
            ...
            >
                <AlertDialogContent>
                    <AlertDialogHeader>
                        <AlertDialogTitle>Permanently Delete Tag</AlertDialogTitle>
                        <AlertDialogDescription>
                            Are you sure you want to permanently delete this tag? This action cannot be undone and
                            will remove all data associated with this tag.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
                        <AlertDialogCancel>Cancel</AlertDialogCancel>
